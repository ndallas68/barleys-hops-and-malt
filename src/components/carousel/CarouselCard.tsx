...
const CarouselCard: React.FC<CardProps> = ({ image }) => {
    ...
    return (
        <motion.div className="relative overflow-hidden h-[20rem] min-w-[200px] rounded-xl flex justify-center items-center"
            ...
            {showOverlay && (
                ...
                >
                    ...
                    <motion.h1 className="bg-white font-semibold text-sm z-10 px-3 py-2 rounded-full flex items-center gap-[0.5ch] hover:opacity-75"
                        ...
                        exit={{ y: 10 }}
                    >
                        <span className="hover:cursor-pointer">Explore Now</span>
